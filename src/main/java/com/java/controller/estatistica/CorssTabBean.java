...
@Named
@ViewScoped
public class CorssTabBean implements Serializable {
	...
	private List<Object[]> listarCrossTab = new ArrayList<>();

	private List<CrossTab> listarTotalCrossTab = new ArrayList<>();
	...
	public void consultar() throws NumberFormatException, NegocioException {
		...
		listarCrossTab = estatisticaService.crossTab(idEmpresa);
		listarCrossTabServicos = estatisticaService.crossTabServicos(idEmpresa);

		for (Object[] cross : listarCrossTab) {

			CrossTab crossTab = new CrossTab();

			String idCategoria = cross[0].toString();
			String janeiro = String.valueOf(cross[1]);
			String fevereiro = String.valueOf(cross[2]);
			String marco = String.valueOf(cross[3]);
			String abril = String.valueOf(cross[4]);
			String maio = String.valueOf(cross[5]);
			String junho = String.valueOf(cross[6]);
			String julho = String.valueOf(cross[7]);
			String agosto = String.valueOf(cross[8]);
			String setembro = String.valueOf(cross[9]);
			String outubro = String.valueOf(cross[10]);
			String novembro = String.valueOf(cross[11]);
			String dezembro = String.valueOf(cross[12]);
			String total = String.valueOf(cross[13]);

			crossTab.setCategoria(idCategoria);
			...
			listarTotalCrossTab.add(crossTab);
	...
	public List<Object[]> getListarCrossTab() {
		return listarCrossTab;
	}

	public void setListarCrossTab(List<Object[]> listarCrossTab) {
		this.listarCrossTab = listarCrossTab;
	}

	public List<CrossTab> getListarTotalCrossTab() {
		return listarTotalCrossTab;
	}

	public void setListarTotalCrossTab(List<CrossTab> listarTotalCrossTab) {
		this.listarTotalCrossTab = listarTotalCrossTab;
	}
